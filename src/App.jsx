...
import CardTemplate from './powerCards/CardTemplate.jsx'
import PowerCardHeader from './powerCards/PowerCardHeader.jsx'
import FlexBoxRow from "./powerCards/FlexBoxRow.jsx";
...
function App() {
  return (<div>
    <PowerCardHeader headerImg={keyConceptsImage}/>

    <div>
      <ul id="concepts">
        <CardTemplate information={concepts[0]}/>
        <CardTemplate information={concepts[1]}/>
        <CardTemplate information={concepts[2]}/>
      </ul>
    </div>
  </div>);
}
